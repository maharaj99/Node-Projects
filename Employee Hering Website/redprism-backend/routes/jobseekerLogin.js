...
// ===================================================
// ROUTER : 1 Send OTP For Login ( POST method api : /api/jobseekerLogin/loginSendOtp )
// ===================================================
...
// ===================================================
// ROUTER : 2 After Send OTP Check Otp, otp id, ph num for login ( POST method api : /api/jobseekerLogin/loginCheckOtp )
// ===================================================
...
// ===================================================
// ROUTER : 3 Login via username password ( POST method api : /api/jobseekerLogin/loginUsername )
// ===================================================
...
router.post('/loginUsername', [
    ...
    if (!errors.isEmpty()) {
        ...
        try {
            ...
            // Check User Name valid or not
            let EmployeeDetails = await Employee.findOne({ user_name: user_name, employee_type: "Job Seeker" });
            if (!EmployeeDetails) {
