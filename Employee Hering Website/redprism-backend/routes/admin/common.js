...
const subMenuMaster = require("../../models/sub_menu_master");
const usermaster = require("../../models/admin_user_master");
...
//.............................................................
// ROUTER 1:  Get user details by authtoken, get method api :/api/admin/common/getUserDetails
//................................................ .............
...
router.get('/getUserDetails', verifyUser, async (req, res) => {
  try {
    ...
    if (!user) {
      return res.status(200).json({ status: 'error', mssg: 'User not found' });
    }
...
//.........................................................
//ROUTER 2 : Get Access Menu & Sub Menu By Auth Token, get method api :/api/admin/common/getMenuSubmenu
//...........................................................
...
//.............................................................
// ROUTER 3:  Check User Can Access Page or Not, post method api :/api/admin/common/pagePermissionCheck
//.............................................................
